...
func TestDefault(t *testing.T) {
	configuration := &config{
		...
		images:             []string{"ghcr.io/pygmystack/haproxy:pr-12", "ghcr.io/pygmystack/dnsmasq:pr-2", "ghcr.io/pygmystack/mailhog:pr-3"},
...
func TestCustom(t *testing.T) {
	configuration := &config{
		...
		images:             []string{"ghcr.io/pygmystack/ssh-agent:pr-2", "ghcr.io/pygmystack/mailhog:pr-3", "phpmyadmin/phpmyadmin", "portainer/portainer", "library/traefik:v2.1.3"},
