...
func TestDefault(t *testing.T) {
	configuration := &config{
		...
		images:             []string{"pygmystack/haproxy:main", "pygmystack/dnsmasq:main", "pygmystack/mailhog:main"},
...
func TestCustom(t *testing.T) {
	configuration := &config{
		...
		images:             []string{"pygmystack/ssh-agent:main", "pygmystack/mailhog:main", "phpmyadmin/phpmyadmin", "library/traefik:v2.1.3"},
