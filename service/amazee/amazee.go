// Amazee provides globally scoped functionality to update amazeeio/* docker images.
package amazee
...
// AmazeeImagePull is the single entry-point for this package which will trigger
// the image pull after identifying all the images which match the criteria.
