...
**Standard schema for one of the following paths**:

_Note: The only supported path on Windows is `$HOME/.pygmy.yml`.
...
# keys is an array all of the SSH key paths which you're utilising.
keys:
